...
function harness(){
 ...
 const audio=new Proxy({settings:{}},{get:(target,k)=>k in target?target[k]:()=>{}}),renderer={setCutTrees(){},setStoryEvents(){},setItemPickups(){},objectVisible(){return true;},players:new Map(),resetSession(){},resize(){},scene(){},loadMap:async()=>true};
