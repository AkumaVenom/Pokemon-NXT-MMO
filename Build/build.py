...
SOURCE_DATA_FILES = {
    "world.json", "adventure.json", "adventure_rom.json", "johto_dialogue.json", "centers.json",
...
REQUIRED_SOURCE = (
    ...
    "Server/data/adventure.json", "Server/data/adventure_rom.json", "Server/data/johto_dialogue.json", "Server/data/centers.json",
    "Server/data/interior_repairs.json", "Server/data/interior_maps.json",
    "Server/data/interior_navigation.json",
    "Tools/publish_adventure.py", "Tools/publish_dialogue.py", "Tools/extract_sigma_dialogue.py", "Tools/prepare_centers.py", "Tools/repair_interiors.py",
    ...
    "Tests/test_adventure.py", "Tests/test_route36_sudowoodo.py", "Tests/test_johto_dialogue.py", "Tests/test_growth.py", "Tests/test_adventure_combat.py",
