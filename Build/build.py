...
REQUIRED_SOURCE = (
    ...
    "Server/nxt/adventure.py", "Server/nxt/story_events.py", "Server/nxt/growth.py", "Server/nxt/portals.py",
    ...
    "Tests/test_adventure.py", "Tests/test_route36_sudowoodo.py", "Tests/test_growth.py", "Tests/test_adventure_combat.py",
