...
REQUIRED_SOURCE = (
    ...
    "Server/nxt/ai_trainers.py", "Server/nxt/ai_store.py", "Tests/test_autonomous_world_life.py", "Tests/test_autonomous_evolution.py",
    "Tests/test_autonomous_performance.py",
    "Docs/AUTONOMOUS_TRAINERS.md", "Docs/AUTONOMOUS_TRAINER_EVOLUTION.md", "Docs/AUTONOMOUS_PERFORMANCE.md",
    "Docs/AUTONOMOUS_PERFORMANCE_TEST_REPORT.md",
    "Docs/ROUTE36_SUDOWOODO.md", "Docs/ROUTE36_SUDOWOODO_TEST_REPORT.md",
    "Docs/JOHTO_SIGMA_NPC_DIALOGUE.md", "Docs/JOHTO_SIGMA_NPC_DIALOGUE_TEST_REPORT.md",
    "Docs/KANTO_FIRERED_NPC_DIALOGUE.md", "Docs/KANTO_FIRERED_NPC_DIALOGUE_TEST_REPORT.md",
    "Server/nxt/adventure.py", "Server/nxt/story_events.py", "Server/nxt/dialogue.py", "Server/nxt/growth.py", "Server/nxt/portals.py",
    "Server/data/adventure.json", "Server/data/adventure_rom.json", "Server/data/kanto_dialogue.json", "Server/data/johto_dialogue.json", "Server/data/centers.json",
    "Server/data/interior_repairs.json", "Server/data/interior_maps.json",
    "Server/data/interior_navigation.json",
    "Tools/publish_adventure.py", "Tools/publish_dialogue.py", "Tools/extract_firered_dialogue.py", "Tools/extract_sigma_dialogue.py", "Tools/prepare_centers.py", "Tools/repair_interiors.py",
    ...
    "Tests/test_adventure.py", "Tests/test_route36_sudowoodo.py", "Tests/test_kanto_dialogue.py", "Tests/test_johto_dialogue.py", "Tests/test_growth.py", "Tests/test_adventure_combat.py",
