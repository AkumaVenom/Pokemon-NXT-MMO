...
struct MP2KContext
{
    ...
    // NXT offline export diagnostics, sample positions at sequencer subframe boundaries.
    struct LoopMark { uint8_t track; size_t startSample, endSample, startTick, endTick; };
    size_t renderSampleCursor = 0;
    std::vector<LoopMark> renderLoops;
