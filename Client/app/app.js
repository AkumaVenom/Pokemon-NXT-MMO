...
function handle(p){
 ...
 switch(p.type){
  ...
  case 'state':if(state&&Number.isSafeInteger(p.revision)&&p.revision<state.revision)return;state=p;updateParty();refreshOwnerModal();break;
